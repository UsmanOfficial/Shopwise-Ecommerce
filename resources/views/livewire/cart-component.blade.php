                	...
                	<table class="table">
                        ...
                        <tbody>
                        	...
                        	<tr>
                            	...
                            	<td class="product-thumbnail"><a href="#"><img src="{{asset('fassets/images')}}/{{$item->model->image}}" alt="{{$item->model->name}}"></a></td>
                                <td class="product-name" data-title="Product"><a href="{{route('product.details',['slug'=>$item->model->slug])}}">{{$item->model->name}}</a></td> 
                                <td class="product-price" data-title="Price">PKR. {{$item->model->regular_price}}</td>
                                <td class="product-quantity" data-title="Quantity"><div class="quantity">
                                <a href="#" class="minus"  wire:click.prevent="DecreaseQuantity('{{$item->rowId}}')">-</a>
                                <input type="text" name="quantity" value="{{ $item->model->quantity }}" title="Qty" class="qty" size="4">
                                <a href="#" class="plus"  wire:click.prevent="IncreaseQuantity('{{$item->rowId}}')">+</a>

                              </div></td>
                              	<td class="product-subtotal" data-title="Total">PKR. {{$item->subtotal}}</td>
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="cart_total_amount">PKR. {{Cart::subtotal()}}</td>
                                </tr>
                                <tr>
                                    <td class="cart_total_label">Tax</td>
                                    <td class="cart_total_amount">PKR. {{Cart::tax()}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="cart_total_amount"><strong>PKR. {{Cart::total()}}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
